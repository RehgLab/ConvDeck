"""
String constants used as code templates by the agent-based code generation system.

These are injected into dynamically generated Python code (e.g., by utils.llm.execution.run_code).
They are NOT executed directly — they are strings containing function definitions.
"""
...
set_text_style(title_text_box, font_size=40, bold=True, italic=True, alignment='center', color=(255, 0, 0), font_name='Times New Roman')
